...
#'@description This function applies brkga algorithm to solve a problem considering
#'objective function and decoder defined by user
#'@references 1. Gon??alves, J.F. and Resende, M.G.C. (2011).
#'Biased random-key genetic algorithms for combinatorial optimization,
#'Journal of Heuristics, 17, p 487-525.
#'@references 2. Gon??alves, J.F and Resende M.G.C. (2018). Biased random-key genetic programming.
...
#'@return \item{ibest}{Generation in which the best solution was found}
#'@import stats
#'@import utils
#'@export
#'
